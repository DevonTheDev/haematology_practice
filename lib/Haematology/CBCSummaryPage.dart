...
import 'package:haematology_practice/main.dart';

void main() {
  runApp(const AnaemiaClassification());
}

class AnaemiaClassification extends StatefulWidget {
  const AnaemiaClassification({Key? key}) : super(key: key);

  @override
  _AnaemiaClassification createState() => _AnaemiaClassification();
}

class _AnaemiaClassification extends State<AnaemiaClassification> {
  ...
  void initState() {
    super.initState();
    // Initialize the testPatient object when the widget is created
    testPatient = Patient();
  }
                                ...
                                actions: <Widget>[
                                  TextButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const AnaemiaClassification()));
                                    },
                                  ),
                                ],
                              );
